...
- Review images from folders or drag-n-drop them into the app window, all without modifying the originals (files are never loaded into the app memory and always being referenced from the disk).
