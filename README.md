...
- Review images from folders or drag-n-dropped into the app window without modifying the originals — files are never loaded into the app memory and always being referenced from the disk.
